...
\providecommand{\algBtables}{\StrLeft{DES Surrogate}{\ntables}}
...
\providecommand{\algsfolder}{DES_DES_S_061407h1851/}
\providecommand{\algorithmA}{DES}
\providecommand{\algorithmB}{DES Surrogate}
\providecommand{\bbobecdfcaptionsinglefunctionssingledim}[1]{
Empirical cumulative distribution of simulated (bootstrapped)
             runtimes, measured in number of $f$-evaluations,
             divided by dimension (FEvals/DIM) for the $51$ 
...
\providecommand{\cocoversion}{{\scriptsize\sffamily{}\color{Gray}Data produced with COCO v2.7.3}}
\providecommand{\numofalgs}{1}
\providecommand{\algname}{bbob f10-0003{}}
\providecommand{\algfolder}{bbob_f10-0003_061319h3927/}
...
\providecommand{\algAtables}{\StrLeft{DES on bbob 1D}{\ntables}}
\providecommand{\ntables}{7}
\providecommand{\pptablesfooter}{
\end{tabularx}
}
